...
face.forEach(()=>{
  ...
  content +="# faceShiftjisCommaBOMnashiRNnohazuJusan50\n";
  content +="ASCII\n";
  content +="DATASET POLYDATA\n";
  content +="POINTS 36 double\n";

  for(i=0;i<M;i++){
    content +=Math.round("3 "+100*face[number][i][0])+" "+Math.round(100*face[number][i][1])+" "+Math.round(100*face[number][i][2])+"\n";
  }

  content +="POLYGONS 52 208\n";
  content +="3 0 1 34\n";
